function fakeParseJSON(str: string) {
  ...
  function parseObject() {
    if (str[i] === '{') {
      ...
      while (i < str.length && str[i] !== '}') {
        ...
        const key: string | undefined = parseString();
        if (key == null) {
          expectObjectKey();
        }
        skipWhitespace();
    ...
    if (value == null) {
      ...
      if (value == null) {
        ...
        if (value == null) {
          value = parseArray();
          if (value == null) {
            value = parseKeyword('true', true);
            if (value == null) {
              value = parseKeyword('false', false);
              if (value == null) {
  ...
  function parseKeyword(name: string, value: unknown) {
...
// function printFailCase(json: string) {
//   try {
